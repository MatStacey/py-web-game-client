...
class WindowProperties():
    ...
    def load_from_json(file):
        ...
        with open(window_properties_json, 'r') as json_file:
            ...
            return WindowProperties(properties['name'], properties['icon'], properties['default_window_size'], properties['url'], properties['profile'], properties['user_agent'])

    def __init__(self, name, icon, size, url, profile, user_agent):
        self.app_name = name
        self.icon_file = icon
